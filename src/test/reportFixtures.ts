...
export const createReportContext = (
  ...
  const value: ReportFixtureValue = {
    ...
    onApplyComposition: noop,
    onResetComposition: noop,
  ...
  return {
    ...
    portfolio: {
      report: value.report,
      deals: value.deals,
      appliedComposition: value.appliedComposition,
      onApplyComposition: value.onApplyComposition,
      onResetComposition: value.onResetComposition,
      baseCapital: value.baseCapital,
      drawdownMode: value.drawdownMode,
      onDrawdownModeChange: value.onDrawdownModeChange,
      hasMtmDrawdown: value.hasMtmDrawdown,
