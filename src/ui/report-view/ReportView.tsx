...
import type { ReportViewContextValues } from './components/ReportViewContext'
...
const ReportView = () => {
  ...
  const contextValue: ReportViewContextValues = {
    navigation: { tab },
    tables: {
    ...
    portfolio: {
      ...
      portfolioDrawdownFallback: analytics.portfolioDrawdownFallback,
